...
class OptimalPath3(CoupledDEVS):
    def __init__(self, name="OptimalPath3"):
        CoupledDEVS.__init__(self, name)
        self.storage = self.addSubModel(Storage(name="storage"))        #outport, response_inport
        ...
        self.result = self.addSubModel(Drain(name="result3"))            #inport,outport
        
        #connect outports >> inports
        self.connectPorts(self.storage.outport, self.station_1.inport)
        self.connectPorts(self.station_1.outport, self.turn_1.inport)

        self.connectPorts(self.turn_1.outport, self.station_2.inport)
        self.connectPorts(self.station_2.outport, self.turn_2.inport)
        
        self.connectPorts(self.turn_2.outport, self.station_3.inport)
        ...
        self.connectPorts(self.station_3.outport, self.turn_2.response_inport)

        self.connectPorts(self.turn_2.outport, self.station_2.response_inport)
        self.connectPorts(self.station_2.outport, self.turn_1.response_inport)

        self.connectPorts(self.turn_1.outport, self.station_1.response_inport)
        self.connectPorts(self.station_1.outport, self.storage.response_inport)
...
#setting
sim = Simulator(OptimalPath3("OptimalPath3"))
